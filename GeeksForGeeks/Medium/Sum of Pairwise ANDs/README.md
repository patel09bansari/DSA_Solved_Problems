...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/sum-of-products5049/1)

## Solved On
06 Sept 2026 at 09:31 am

<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-products5049/1">Sum of Pairwise ANDs</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of integers, calculate the sum of bitwise AND for all pairs of elements such that the first index is less than the second index.</span></p>
