...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/high-effort-vs-low-effort0213/1)

## Solved On
10 Aug 2026 at 06:58 pm

<h2><a href="https://www.geeksforgeeks.org/problems/high-effort-vs-low-effort0213/1">High Effort vs Low Effort</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given two integer arrays <strong>h[]</strong> and <strong>l[]</strong>, where h[i] and l[i] denote the number of tasks that can be completed on the<strong> i-th </strong>day by performing a high-effort task and a low-effort task, respectively.</span></p>
