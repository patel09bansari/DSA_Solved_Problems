...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/largest-zigzag-sequence5416/1)

## Solved On
09 Aug 2026 at 11:19 am

<h2><a href="https://www.geeksforgeeks.org/problems/largest-zigzag-sequence5416/1">Largest Zigzag Sequence</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given a square matrix <strong>mat[][]</strong> of size <strong>n × n</strong></span><span style="font-size: 18.6667px;">. A zigzag sequence starts from the top and ends at the bottom. Two consecutive elements of sequence cannot belong to the same column. </span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ n ≤ 100<br>1 ≤ mat[i][j] ≤ 1000&nbsp;</span></p>