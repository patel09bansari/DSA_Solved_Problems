...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/adventure-in-a-maze2051/1)

## Solved On
12 Aug 2026 at 06:44 pm

<h2><a href="https://www.geeksforgeeks.org/problems/adventure-in-a-maze2051/1">Adventure in a Maze</a></h2><h3>Difficulty Level: Hard</h3><hr><p><span style="font-size: 14pt;">Given a maze represented as an <strong>n x n</strong> grid, <strong>grid[][]</strong>, using 0-based indexing. Each cell contains one of the values 1, 2, or 3, which determines the direction(s) you are allowed to move from that cell:</span></p>
<ul>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ n ≤ 100</span></p>